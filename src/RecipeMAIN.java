public class RecipeMAIN {
    ...
    public static void main(String[] args) {
        ...
        Recipe r1 = new Recipe("Babka piaskowa","150 g masła, 200 g mąki ziemniaczanej, 100 g mąki pszennej, 3 jajka, 150 g cukru, opakowanie (16 g) cukru waniliowego, 1.5 płaskiej łyżeczki proszku do pieczenia, skórka otarta z jednej cytryny, cukier puder do posypania", 60,"Żółtka oddzielić od białek. Białka ubić na sztywną pianę. Miękkie masło zmiksować na puszystą masę, cały czas miksując dodać cukry. Następnie miksując dodawać żółtka, przesiane mąki wymieszane z proszkiem do pieczenia i skórkę otartą z cytryny. Na koniec bardzo delikatnie wmieszać do masy pianę z białek. Ciasto przełożyć do wysmarowanej masłem i wysypanej bułką tartą formy. Piec w temperaturze 160 stopni przez około 1 h. Wystudzone ciasto posypać cukrem pudrem.");
        ...
        //recipeRepo.add(r1);
        //recipeRepo.add(r2);
        recipeRepo.modifyAndAdd(r1);
        recipeRepo.modifyAndAdd(r2);

        //recipeRepo.displayAll();
        recipeRepo.displayAllModified();
